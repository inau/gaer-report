...
\begin{figure}[ht] \centering \includegraphics[scale=.5]{flat_chair}
...
\begin{figure}[ht] \centering \subfloat[]{
		\includegraphics[width=.9\columnwidth]{selection} } \hfil
	\subfloat[]{ \includegraphics[width=.9\columnwidth]{selection2} }
...
\begin{figure}[ht] \centering \includegraphics[width=.9\columnwidth]{box_chair}
