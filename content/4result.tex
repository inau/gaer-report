...
However, in an attempt to reach higher generations, some experiments were 
...
\begin{figure}[ht]
	\centering
	\subfloat[]{
		\includegraphics[width=.45\columnwidth]{actual_chair}
		\label{fig:real_chair}
	} \hfil
	\subfloat[]{
		\includegraphics[width=.45\columnwidth]{metro_stand2}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=1]{metro_stand_real}
